...
%% AMUD
UD_up=PAL_AMUD_setupUD_up('startvalue',0.1,'up',1,'down',3,'max',1,'stepsizeup',0.01,'stepsizedown',0.01,'stopcriterion','reversals','stopRule',8);
UD_down =PAL_AMUD_setupUD_down('startvalue',0.9,'up',1,'down',3,'max',1,'stepsizeup',0.01,'stepsizedown',0.01,'stopcriterion','reversals','stopRule',8);
