...
Array(2,1) = {'girls carry dolls'}; %
Array(2,2) = {'girls carry guns'};

Array(3,1) = {'ants build anthill'};%
Array(3,2) = {'ants build monkeys'};

Array(4,1) = {'reporter tells news'};%
Array(4,2) = {'reporter tells never'};

Array(5,1) = {'students print notes'};%
Array(5,2) = {'students print water'};
