...
fprintf(fid,'subID,domEyeR,threshStHi,threshStLo,thresh,Trial_number,Sentence_ID,Sentence_pixel_length,Congruent_1,Familiar_1,LocationTop_1,LocationcuedTop_1,Trialcorrect_1,Trialbroken_1,ST\n');
fclose(fid);
...
for i=1:ntrials;
    ...
    try
        ...
        while 1,
            ...
            ResultSet(i,12)=(location_cued==1); %location_cued_Top =1
