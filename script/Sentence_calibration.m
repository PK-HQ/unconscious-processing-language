function [textpt3]=Sentence_calibration(wordNo,condition);
Array=cell(5,2); %0 blank + 20 sentences

Array(1,1) = {'animals eat corn'};%%
Array(1,2) = {'animals eat ate'};
Array(2,1) = {'matron buys ice'};
Array(2,2) = {'matron buys cash'};
Array(3,1) = {'fan cools enemy'};
Array(3,2) = {'fan cools itself'};

Array(4,1) = {'shop makes books'};
Array(4,2) = {'shop makes made'};
Array(5,1) = {'girls carry dolls'}; %%
Array(5,2) = {'girls carry guns'};
Array(6,1) = {'chef reveals dish'};
Array(6,2) = {'chef reveals cook'};


Array(7,1) = {'kids offend people'};
Array(7,2) = {'kids offend books'};
Array(8,1) = {'ants build anthill'};%%
Array(8,2) = {'ants build monkeys'};
Array(9,1) = {'teacher scolds kids'};
Array(9,2) = {'teacher scolds air'};



Array(10,1) = {'driver steers boat'};
Array(10,2) = {'driver steers water'};
Array(11,1) = {'sailor steers boat'};
Array(11,2) = {'sailor steers bike'};
Array(12,1) = {'teens break windows'};
Array(124,2) = {'teens break broken'};

Array(13,1) = {'students print notes'};%%
Array(13,2) = {'students print water'};
Array(14,1) = {'plumbers fix toilets'};%
Array(14,2) = {'plumbers fix programs'};
Array(15,1) = {'reporter tells news'};%%
Array(15,2) = {'reporter tells never'};
%{
